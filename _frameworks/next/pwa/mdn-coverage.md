...
- Define app icons
- Create a standalone app window
- Customize colors
- Display icon badges
- Expose shortcuts
...
- Service worker APIs (messaging, fetch events, Clients interface)
- Background Sync & Background Fetch APIs
- IndexedDB, Badging, Notifications, Web Share, Window Controls Overlay
